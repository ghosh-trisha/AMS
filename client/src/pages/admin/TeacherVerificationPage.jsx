...
const TeacherVerificationPage = () => {
    ...
    const fetchTeachers = async () => {
        try {
            const response = await axios.get("http://localhost:8080/api/admin/teachers/all/verify/status");
    ...
    const updateVerifyStatus = async (teacherId, isVerified) => {
        try {
            await axios.post("http://localhost:8080/api/admin/teachers/all/verify/status", {
                teacherId, verified: isVerified
            });
            toast.success("Teacher verification status updated successfully!");
            await fetchTeachers();
        } catch (error) {
        ...
        <motion.div className="p-6 max-w-7xl mx-auto">
            ...
            <div className="flex justify-center items-center mb-6">
                <motion.p
                    ...
                    transition={{ duration: 0.5 }}
                >
                    Review and verify your below teachers
                </motion.p>
